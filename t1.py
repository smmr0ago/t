...
class DQN(nn.Module):
    def __init__(self, state_size, action_size):
        ...
        self.conv1 = nn.Conv2d(1, 32, (8, 8), stride=(4, 4), padding=1, input_shape=state_size)
        self.conv2 = nn.Conv2d(64, (4, 4), stride=(2, 2), padding=1)
        self.conv3 = nn.Conv2d(64, (3, 3), stride=(1, 1), padding=1)
        self.flatten = nn.Flatten()
        self.fc = nn.Linear(, 512)
        self.fc_out = nn.Linear(512, action_size)
...
class DQNAgent:
    def __init__(self, state_size=(84, 84, 4), action_size):
        self.render = False
